...
Boundary conditions:
\begin{itemize}
    \item inlet concentration: $C_{in}=\frac{1}{1-cs}+C_{out}$ where cs is the Control Section relative distance from the inlet;
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{images/digitalRocks/GreenRiverFormation.png}
...
\begin{figure}[htbp!]
    ...
    \hspace{0.05\textwidth}
    \includegraphics[width=0.45\textwidth]{images/digitalRocks/fractureNetwork.png}
    \caption{Fracture network in OpenPNM}
