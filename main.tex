...
\paragraph{Input} Table \ref{fig:InputV6} lists the input values for parameters used in the current setup: 
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{images/dfnWorksImages/dfnDiffEugDriverV6.png}
    \caption{Driver input for V6.}
    \label{fig:InputV6}
\end{figure}
