...
\begin{figure}[htbp]
    ...
    \caption{Effective diffusion vs conductance distribution variance. The histogram refers to the last simulation where s=6.}
...
\begin{figure}[htbp!]
    ...
    \caption{Grid and concentration for effective diffusion evaluation for variance s=6.}
