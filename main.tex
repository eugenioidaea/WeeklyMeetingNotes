...
\end{equation}
is equivalent to the harmonic mean of the collection of conductance values of each throat
\begin{equation}
...
\end{figure}
The conductance of each pipe $C_i$ is equal to the harmonic mean (Eq. \ref{fig:HarmonicMean}) of the conductances of the throats that form the pipe.
