...
\begin{figure}[htbp!]
    ...
    \caption{Left: Plateau-normalised BTC. Right: Complementary plateau-normalised BTC.}
...
\begin{figure}[htbp!]
    ...
    \caption{Clockwise: Plateau-normalised BTC. Right: Complementary plateau-normalised BTC.}
