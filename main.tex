...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/survTimeDistCompare.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{images/compareAdsRatesDiff.png}
        \caption{Reaction rates for different diffusivity values}
    \end{subfigure}
    \hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.5\textwidth]{images/compareDiffNormAdsRates.png}
        \caption{}
    \end{subfigure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{images/compareAdsRatesApe.png}
        \caption{Reaction rates for different values of aperture's width}
    \end{subfigure}
    \hfill
    \begin{subfigure}
        \centering
        \includegraphics[width=0.5\textwidth]{images/compareApeNormAdsRates.png}
        \caption{Reaction rates for different values of aperture's width from normalised survival time distributions}
    \end{subfigure}
    \caption{Reaction rates for different aperture's widths from normalised survival time distributions}
