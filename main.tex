...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/verificationInfinite.png} % Replace with your image path
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/verificationInfinite1e5.png} % Replace with your image path
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/verificationSemi-infinite.png} % Replace with your image path
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/verificationSemi-infiniteImproved.png} % Replace with your image path
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Survival time distribution curves from analytical (red solid), experimental (blue dots) well-mixed scenario and diffusion-limited experimental case.}
        \label{fig:survTimeDist}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/survTimeDistRateCompare.png}
        \caption{Reaction rates from analytical (red solid), experimental (blue dots) well-mixed scenario and diffusion-limited experimental case.}
        \label{fig:survTimeDistRate}
    \end{subfigure}
    \caption{$10^5$ particles and 20 time steps. The value of the exponent k for the analytical case is 0.5.}
    \label{fig:survTime}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Trajectories from matrix diffusion implemented according to Semra 1993 and using Df=0.1 and Dm=0.001}
        \label{fig:MatDiff}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Analytical solution vs numerical experiment using matrix diffusion}
        \label{fig:MatrixDiffusionVerification}
    \end{subfigure}
    \caption{100 particles and 1000 time steps}
