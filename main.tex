...
\begin{itemize}
    ...
    where $s=0.5$ is the standard deviation $\sigma$ of the underlying normal distribution, $loc$ is a parameter that shifts the distribution along the x-axis and changes the argument of the logarithm and $scale$ corresponds to the exponential of the mean of the underlying distribution that is $ln(scale)=\mu$.  
\end{itemize}
...
\begin{itemize}
    \item conductance from OpenPNM:
    \item conductance geometric mean:
\end{itemize}
